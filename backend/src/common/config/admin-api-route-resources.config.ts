...
const ADMIN_API_ROUTE_RESOURCE_PREFIXES_RAW: ReadonlyArray<{
  ...
  {
    prefix: '/api/v1/admin/furniture-schedules',
    resourceId: 'admin.crm.furniture-schedules',
  },
  {
    prefix: '/api/v1/admin/joint-objects',
  ...
  { prefix: '/api/v1/admin/messenger', resourceId: 'admin.messenger' },
  { prefix: '/api/v1/admin/calendar', resourceId: 'admin.calendar' },
