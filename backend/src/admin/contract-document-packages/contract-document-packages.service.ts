...
export class ContractDocumentPackagesService {
  ...
  async setWindowsSettings(dto: SetRepairContractSettingsDto, updatedById?: string) {
    return this.setWorkPeriodSettings(ContractDocumentPackageKind.WINDOWS, dto, updatedById);
  }
