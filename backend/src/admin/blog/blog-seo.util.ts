/**
 * Автозаполнение SEO для статей блога из заголовка и HTML-текста.
 */
...
/**
 * Описание для meta: сначала краткое описание статьи, иначе первые символы из текста.
 */
...
/** Явное описание из формы или автогенерация из краткого текста/HTML. */
