  ...
  return (
    <aside className={styles.help}>
      ...
      <p className={styles.helpText}>
        ...
        может также увидеть свой IP на экране «Начните рабочий день» или на странице{' '}
        <strong>CRM → Мой рабочий день</strong>.
      </p>
      <p className={styles.helpText}>
        Если IP ещё не внесён в список, супер-администратор может временно включить для офиса опцию{' '}
        <strong>«Не проверять IP при начале рабочего дня»</strong> (вкладка «Офисы»), настроить
        адреса и затем снова включить проверку.
      </p>
