...
const EVENTS_ITEMS = [
  'Отметьте галочками события: отзывы, заказы, чат поддержки, формы и квизы, обучение, учёт рабочего времени, путевые листы, электронное подписание договоров.',
  'Обратная связь по обучению и публичному сайту доступна в настройках супер-администратору.',
  'События подписания договоров (подписан, отклонён, открыт клиентом) приходят лично менеджеру, создавшему сессию подписания.',
