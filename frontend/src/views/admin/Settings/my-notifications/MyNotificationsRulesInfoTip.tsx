...
const EVENTS_ITEMS = [
  'Отметьте события, по которым присылать уведомления: отзывы, заказы, чат поддержки, формы и квизы, обучение, учёт рабочего времени, путевые листы, графики монтажей / ремонтов / мебели.',
