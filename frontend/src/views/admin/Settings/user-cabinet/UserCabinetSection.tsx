      ...
      <section className={styles.section}>
        ...
        <form onSubmit={handleSave} className={styles.form}>
          ...
          <div className={styles.consentSection}>
            <h3 className={styles.consentTitle}>Согласие на обработку данных (единая политика)</h3>
            <p className={styles.consentHint}>
              Единая политика для основного сайта (регистрация, «Заказать звонок», «Записаться на
              замер», «Рассчитать стоимость», «Письмо директору») и квизов на отдельных доменах. На
              основном сайте по клику на «персональных данных» — <code>/auth/privacy-policy</code>,
              на квизах — <code>/quiz/privacy-policy</code>.
            </p>
