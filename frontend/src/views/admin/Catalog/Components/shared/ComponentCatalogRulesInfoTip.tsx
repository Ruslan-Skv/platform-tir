...
const COMPONENT_CATALOG_HELP = {
  ...
  steps: [
    'Справочник устроен деревом: группа моделей → подгруппа по цвету → позиции (стойка, наличник, добор). Разверните нужную ветку — комплектующие одного цвета будут рядом.',
