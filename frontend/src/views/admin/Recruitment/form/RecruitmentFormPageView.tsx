...
import type { RecruitmentFormPageModel } from './hooks/useRecruitmentFormPage';

type RecruitmentFormPageViewProps = {
  model: RecruitmentFormPageModel;
};

export function RecruitmentFormPageView({ model }: RecruitmentFormPageViewProps) {
  const {
    router,
    isEdit,
    form,
      ...
      {score ? (
        <div className={styles.scorePanel}>
          ...
          {score.strengths.length > 0 ? (
            <p className={styles.scoreStrengths}>
        ...
        {isEdit ? (
          <>
            <section className={styles.section}>
              ...
              <p className={styles.traineeHint}>
              ...
              <div className={styles.traineeLink}>
                <div className={`${styles.field} ${styles.traineeFieldFlex}`}>
              ...
              {training ? (
                <div className={styles.trainingBlock}>
                  ...
                  <div className={styles.trainingProgress}>
                    <TrainingProgressBar percent={training.completionPercent} />
                  </div>
                  <p className={styles.trainingProgressNote}>
