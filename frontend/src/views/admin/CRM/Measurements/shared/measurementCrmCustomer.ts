...
import { parseObjectAddresses } from '@/views/admin/CRM/Customers/shared/crmCustomerExtendedProfile';
import { personDisplayNameFromCrmDetail } from '@/views/admin/CRM/Customers/shared/crmCustomerName';
import { formatCrmPhoneDisplay } from '@/views/admin/CRM/Customers/shared/crmCustomerPhone';
