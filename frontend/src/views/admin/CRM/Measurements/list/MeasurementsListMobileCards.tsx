            ...
            >
              <div className={styles.mobileCardTop}>
                <div className={styles.mobileCardMain}>
                  <div className={styles.mobileCardName}>{m.customerName || 'Без ФИО'}</div>
                  {m.customerPhone ? (
                    <div className={styles.mobileCardMeta}>{m.customerPhone}</div>
                  ) : null}
                  {m.customerAddress ? (
                    <div className={styles.mobileCardMeta}>{m.customerAddress}</div>
                  ) : null}
                </div>
