...
const TRASH_ITEMS = [
  'Удалять в корзину можно только ручные записи («Ручн.») — кнопка корзины в конце строки.',
  'Сотрудник удаляет свои записи (он менеджер или автор) и только сделанные в текущем месяце; супер-админ — любые ручные записи без ограничения по сроку.',
  'Удалённая запись исчезает из журнала, итогов и остатка кассы менеджера.',
  'Иконка корзины в шапке — сама корзина: в ней видна вся информация по удалённым записям. Восстановление из корзины невозможно.',
] as const;
    ...
    <AdminHelpTooltip
      ...
      body={
        <div className={styles.body}>
          ...
          <section className={styles.section}>
            <p className={styles.sectionTitle}>Удаление и корзина</p>
            <ul className={styles.list}>
