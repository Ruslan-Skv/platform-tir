...
const LIST_ITEMS = [
  ...
  'Чипы сверху — сводка за период: рабочие дни, опоздания, ранние уходы, авто-закрытия, время «по делам», согласованные выходные.',
] as const;
...
const JOURNAL_ITEMS = [
  ...
  'Согласованные выходные без явки показываются отдельными строками «Выходной».',
