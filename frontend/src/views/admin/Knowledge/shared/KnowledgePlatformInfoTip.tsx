...
const PLATFORM_STEPS = [
  ...
  'Раздел «Тесты» — итоговые тесты по категориям. Доступ к разделу и к тестам каждой категории настраивается отдельно.',
...
const PLATFORM_HELP = {
  ...
  traineeLead:
    'Уважаемый стажёр, для получения хороших шансов на ваше трудоустройство в компании вам достаточно изучить не менее 30% материалов в каждой категории (кроме категории «Мебель на заказ», "Дизайн интерьера").',
} as const;
