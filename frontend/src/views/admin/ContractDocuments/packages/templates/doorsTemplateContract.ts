/** Шаблон вкладки «Договор» (направление «Двери»). Плейсхолдеры: {{customer.*}}, {{executor.*}}, {{object.*}}, {{contract.*}}. */
export const doorsTemplateContract = `
<div class="docPrint docPrintContractCompact">
  <h1 style="text-align: center; font-size: 14pt; margin: 0 0 12pt;">
    ...
    <span style="font-weight: normal; font-size: 11pt;">на поставку и установку дверей</span>
  </h1>
  ...
  <p style="text-align: justify; text-indent: 1.25cm; margin: 0 0 8pt;">
    1.1. Исполнитель обязуется изготовить (поставить) и установить двери по объекту, расположенному по адресу:
  ...
  <p style="text-align: justify; text-indent: 1.25cm; margin: 0 0 8pt;">
    1.2. Состав, характеристики и количество дверей определяются спецификацией и счётом-заказом, являющимися
  ...
  <p style="margin-top: 24pt; text-align: justify; text-indent: 1.25cm;">
    Настройте полный текст договора в разделе «Библиотека шаблонов договоров» (направление «Двери», тип документа «Договор»).
  </p>
