...
Структура раздела «Оформление договоров» — шесть направлений, семейства комплектов, общий код в `platform/`.
...
| `FURNITURE` | Мебель           | `FURNITURE_LIKE` | ноги изготовления/монтажа/техники  |
...
│   └── workOrders/
├── families/
│   └── product-like/ — спецификация, Д/с, стоимость (окна, двери, жалюзи, …)
...
| `FURNITURE_LIKE` | Мебель                                | До 3 договоров; оплаты в hub по ногам (ПКО / ПКО-М / ПКО-Т)                  |
