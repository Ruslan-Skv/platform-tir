...
const SPEC_TAB_COMPACT = `${cdEstimateTab.estimateTabCompact} ${cdWindows.estimateTabCompact} ${cdHubModals.estimateTabCompact}`;
const SPEC_BLOCK = `${cdDataTab.blockData} ${cdWindows.blockData}`;
const SPEC_DATA_COMPACT = `${cdEstimateTab.dataCompact} ${cdDataTab.dataCompact} ${cdHubModals.dataCompact}`;
const SPEC_FORM_GRID = `${cdDataTab.formGrid} ${cdWindows.formGrid}`;
...
const SPEC_ROOT = `${SPEC_BLOCK} ${SPEC_DATA_COMPACT} ${SPEC_TAB_COMPACT} ${cdWindows.windowsContractTabTypography}`;
  ...
  return (
    <div className={SPEC_ROOT}>
      <div className={SPEC_FORM_GRID}>
          ...
          <div className={SPEC_SECTION_FIELDS}>
            <div className={`${cdHubModals.windowsSpecMainRow} ${cdEstimateTab.fieldSpanAll}`}>
              ...
              <div className={`${SPEC_FIELD} ${cdHubModals.windowsSpecFileField}`}>
                <span
                  className={`${cdHubModals.windowsSpecFieldCaption} ${cdWindows.windowsSpecFieldCaption}`}
                ...
                >
                  ...
                  {!fileUrl.trim() ? (
                    <p
                      className={`${cdHubModals.windowsSpecFileHint} ${cdWindows.windowsSpecFileHint}`}
                    >
                ...
                {fileUrl.trim() ? (
                  <p
                    className={`${cdHubModals.windowsSpecFileMeta} ${cdWindows.windowsSpecFileMeta}`}
                  >
                    <a
        ...
        <div
          className={`${SPEC_FIELD} ${cdEstimateTab.fieldSpanAll} ${cdWindows.estimateSheetField}`}
          aria-hidden
        >
