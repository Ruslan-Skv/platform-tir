...
export function RepairContractPaymentsTab({
  ...
  const windowsCostBreakdown = useMemo(
    () =>
      isProductDirectionPackageKind(packageKind) ? computeWindowsContractCostBreakdown(form) : null,
    [packageKind, form]
  );
          ...
          <div className={cdBase.paymentsPreFormSummarySections}>
            <section className={cdBase.paymentsPreFormSummarySection}>
              ...
              {paymentsContractDiscountPct > 0 ? (
                <p className={cdWindows.hint} style={{ margin: '0 0 8px' }}>
            ...
            <section className={cdBase.paymentsPreFormSummarySection}>
              ...
              {loading ? (
                <p className={cdWindows.hint}>Загрузка…</p>
              ) : (
                <div className={cdBase.paymentsKvGrid}>
        ...
        {isHubConductLayout ? (
          <div className={`${measurementBlankStyles.blankSheet} ${cdBase.paymentsHubConductBlank}`}>
            <div className={`${cdBase.paymentsFormHubRow} ${cdBase.paymentsFormHubRowCompact}`}>
              ...
              {hubConductAllBasesDone ? (
                <p className={`${cdWindows.hint} ${cdBase.paymentsFormHubHint}`}>
          ...
          <>
            <div className={cdBase.paymentsFormGrid}>
              ...
              <div className={`${cdBase.field} ${cdEstimateTab.fieldSpanAll}`}>
                ...
                <p className={cdWindows.hint} style={{ marginTop: 6 }}>
  ...
  return (
    <div
      className={`${cdDataTab.blockData} ${cdWindows.blockData} ${cdWindows.dataCompact} ${cdBase.paymentsTab} ${cdDataTab.paymentsTab} ${
