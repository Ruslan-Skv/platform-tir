...
import { contractDateToDdMmYyyy } from '../../../../shared/contractDateFormat';
...
export function getDisplayContractNumber(pkg: PackageContractSource): string {
  ...
  const c = repairFormContractBlock(fd);
...
export function getRepairContractNumberDisplayForForm(form: RepairPackageFormData): string {
