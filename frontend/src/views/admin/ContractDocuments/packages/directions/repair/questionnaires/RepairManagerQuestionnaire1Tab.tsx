  ...
  return (
    <div className={Q_FORM_GRID}>
      <div className={`${Q_SECTION_CARD} ${cdEstimateTab.fieldSpanAll}`}>
        <h3 className={`${Q_SECTION_TITLE} ${cdEstimatesList.managerQuestionnaire1Title}`}>
          Анкета (опросник)
        </h3>
        <p className={Q_HINT} style={{ marginTop: 0 }}>
        ...
        {syncSourceLabel === 'crm' || syncSourceLabel === 'package' ? (
          <p className={Q_HINT} style={{ margin: '8px 0 0' }}>
      ...
      <div className={`${Q_SECTION_CARD} ${cdEstimateTab.fieldSpanAll}`}>
        <h4 className={Q_SECTION_TITLE}>1) Контактные данные и объект</h4>
        <div className={Q_SECTION_FIELDS}>
          <div className={`${Q_FIELD} ${cdEstimateTab.fieldSpanAll}`}>
            <p className={Q_HINT} style={{ margin: '0 0 8px' }}>
      ...
      <div className={`${Q_SECTION_CARD} ${cdEstimateTab.fieldSpanAll}`}>
        <h4 className={Q_SECTION_TITLE}>2) Информация о заказе (что нужно сделать?)</h4>
        <div className={Q_SECTION_FIELDS}>
          <div className={`${Q_FIELD} ${cdEstimateTab.fieldSpanAll}`}>
      ...
      <div className={`${Q_SECTION_CARD} ${cdEstimateTab.fieldSpanAll}`}>
        <h4 className={Q_SECTION_TITLE}>3) Откуда узнали о нас? (источник трафика)</h4>
        <div className={Q_SECTION_FIELDS}>
          <div className={`${Q_FIELD} ${cdEstimateTab.fieldSpanAll}`}>
            <div
      ...
      <div className={`${Q_SECTION_CARD} ${cdEstimateTab.fieldSpanAll}`}>
        <h4 className={Q_SECTION_TITLE}>4) Пожелания по мастеру (и контроль качества)</h4>
        <div className={Q_SECTION_FIELDS}>
          <div className={`${Q_FIELD} ${cdEstimateTab.fieldSpanAll}`}>
      ...
      <div className={`${Q_SECTION_CARD} ${cdEstimateTab.fieldSpanAll}`}>
        <h4 className={Q_SECTION_TITLE}>5) Почему выбрали этого мастера / нашу компанию?</h4>
        <div className={Q_SECTION_FIELDS}>
          <div className={`${Q_FIELD} ${cdEstimateTab.fieldSpanAll}`}>
            <div
              className={cdEstimatesList.managerQuestionnaireNeedsGrid}
      ...
      <div className={`${Q_SECTION_CARD} ${cdEstimateTab.fieldSpanAll}`}>
        <h4 className={Q_SECTION_TITLE}>6) Дополнительные услуги (кросс-продажи)</h4>
        <div className={Q_SECTION_FIELDS}>
          <div className={`${Q_FIELD} ${cdEstimateTab.fieldSpanAll}`}>
