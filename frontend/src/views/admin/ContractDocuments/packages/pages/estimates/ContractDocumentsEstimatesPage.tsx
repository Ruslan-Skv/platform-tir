...
} from '../../directions/repair/estimates/estimatePipelineStage';
import {
...
} from '../../directions/repair/estimates/estimateWorkScopeTree';
import {
...
import { persistRepairPackageAfterRemovingEstimatePreset } from '../../directions/repair/estimates/repairDetachEstimatePresetFromPackages';
import {
  getDisplayContractDate,
  getDisplayContractNumber,
} from '../../directions/repair/form/packageContractDisplay';
import { mergeRepairPackageFormData } from '../../directions/repair/repairPackageForm';
...
export function ContractDocumentsEstimatesPage() {
  ...
  const renderEstimateAddressGroupRow = (
    ...
    return (
      ...
      >
        <td className={cdEstimatesList.repairContractsListSelectCol}>
          <button
            type="button"
        ...
        <td className={cdEstimatesList.repairContractsListActionsCol}>
          <div
    ...
    return (
      <tr
        ...
        className={`${dataTableStyles.row} ${cdEstimatesList.estimatesListEstimateRow}${
          isChildRow ? ` ${cdBase.repairContractsListChildRow}` : ''
        }`}
      >
        <td className={cdEstimatesList.repairContractsListSelectCol} />
        <td className={cdEstimatesList.estimatesListTitleCell}>
  ...
  return (
    ...
    >
      <div className={cdEstimatesList.editorHeader}>
        <div>
          ...
          <div className={cdEstimatesList.estimatesEditorHeaderStack}>
            <div className={cdEstimatesList.repairContractsListHeaderLeft}>
              ...
              <div className={measurementFormStyles.titleWithAutosave}>
                <span
                  className={cdEstimatesList.repairContractsListCount}
                  title={
                    !archiveView
      ...
      <div
        className={`${dataTableStyles.tableContainer} ${cdEstimatesList.repairContractsDirectoryTable} ${cdEstimatesList.estimatesDirectoryTable}${archiveView ? ` ${cdEstimatesList.estimatesDirectoryTableArchive}` : ''}`}
      >
        <div className={dataTableStyles.tableWrapper}>
          <div className={dataTableStyles.scrollContainer}>
            <table
              className={`${dataTableStyles.table} ${cdEstimatesList.repairContractsListTable} ${cdEstimatesList.estimatesListTable}`}
            >
              <thead className={dataTableStyles.stickyHeader}>
                <tr>
                  <th
                    className={cdEstimatesList.repairContractsListSelectCol}
                    aria-label="Группа"
                  />
                  <th>Расчёт</th>
                  ...
                  <th>Наценка, %</th>
                  <th
                    className={cdEstimatesList.repairContractsListActionsCol}
                    aria-label="Действия"
                  />
                </tr>
              </thead>
