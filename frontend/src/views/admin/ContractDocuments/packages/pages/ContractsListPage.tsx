...
import { adminContractDocumentsContractsRepairPackageHref } from '@/views/admin/ContractDocuments/packages/config/contractDocumentsContractsRoutes';
...
import { applyRepairContractDiscountToNullableBase } from '../directions/repair/estimates/repairContractDiscount';
import { buildFormDataForRepairPackageCopy } from '../directions/repair/form/cloneRepairPackageFormDataForCopy';
import {
...
import { formatRepairWorkOrderHubModalTitle } from '../directions/repair/workOrders/repairWorkOrderHubTabs';
import { RepairContractPackageHubIcon } from '../shared/hub/RepairContractPackageHubIcon';
import { RepairContractPackageHubModal } from '../shared/hub/RepairContractPackageHubModal';
import { RepairContractWorkOrdersHubIcon } from '../shared/hub/RepairContractWorkOrdersHubIcon';
import { RepairContractWorkOrdersHubListModal } from '../shared/hub/RepairContractWorkOrdersHubListModal';
...
function repairListPipelineStatusBadgeClass(st: RepairListPipelineStatus): string {
  const base = cdHub.repairContractsListStatusBadge;
  switch (st) {
    case 'IN_PROJECT':
      return `${base} ${cdHub.repairContractsListStatusBadgeInProject}`;
    case 'SIGNED':
      return `${base} ${cdHub.repairContractsListStatusBadgeSigned}`;
    case 'WORK_IN_PROGRESS':
      return `${base} ${cdHub.repairContractsListStatusBadgeWork}`;
    case 'CLOSED':
      return `${base} ${cdHub.repairContractsListStatusBadgeClosed}`;
    case 'REFUSED':
      return `${base} ${cdHub.repairContractsListStatusBadgeRefused}`;
  }
}
...
export function ContractsListPage() {
  ...
  return (
    <div className={`${cdBase.page} ${cdWorkspace.pageWide} ${cdHub.repairContractsListPage}`}>
      <div className={cdHub.editorHeader}>
        <div className={cdHub.repairContractsListHeaderLeft}>
          <h1 className={cdHub.title}>Договора</h1>
          <span className={cdHub.repairContractsListCount}>
      ...
      <div className={cdHub.repairContractsListFilters}>
        <input
          type="search"
          ...
          className={repairContractsListFilterFieldClass(
            cdHub.repairContractsListSearchInput,
            Boolean(search.trim()),
            cdHub.repairContractsListFilterActive
          )}
        ...
        <select
          ...
          disabled={loading}
          className={repairContractsListFilterFieldClass(
            cdHub.repairContractsListSelect,
        ...
        <select
          ...
          disabled={loading}
          className={cdHub.repairContractsListSelect}
        ...
        <label className={cdHub.repairContractsListDateLabel}>
          <span className={cdHub.repairContractsListDateLabelText}>Дата от</span>
          <input
            type="date"
            value={dateFrom}
            ...
            disabled={loading}
            className={repairContractsListFilterFieldClass(
              cdHub.repairContractsListDateInput,
              Boolean(dateFrom),
              cdHub.repairContractsListFilterActive
            )}
            aria-label="Дата от"
        ...
        <label className={cdHub.repairContractsListDateLabel}>
          <span className={cdHub.repairContractsListDateLabelText}>Дата до</span>
          <input
            type="date"
            value={dateTo}
      ...
      <div className={`${dataTableStyles.tableContainer} ${cdHub.repairContractsDirectoryTable}`}>
        <div className={dataTableStyles.tableWrapper}>
          <div className={dataTableStyles.scrollContainer}>
            <table className={`${dataTableStyles.table} ${cdHub.repairContractsListTable}`}>
              <thead className={dataTableStyles.stickyHeader}>
                <tr>
                  <th className={cdHub.repairContractsListSelectCol} aria-label="Группа" />
                  <th className={cdHub.repairContractsListKindCol}>Направл.</th>
                  ...
                  <RepairContractsListSortableTh
                    ...
                    onSort={handleListSortChange}
                  />
                  <th className={cdHub.repairContractsListActionsCol} />
                </tr>
              </thead>
                ...
                {loading ? (
                  ...
                  paginatedDisplayItems.map((item) => {
                    if (item.type === 'object') {
                      ...
                      return (
                        <tr
                          ...
                          className={`${dataTableStyles.row} ${cdBase.repairContractsListObjectRow} ${
                            expanded ? cdBase.repairContractsListObjectRowExpanded : ''
                          }`}
                        >
                          <td className={cdHub.repairContractsListSelectCol}>
                            <button
                              type="button"
                              className={cdBase.repairContractsListExpandBtn}
                          ...
                          <td className={cdHub.repairContractsListKindCol}>Объект</td>
                          <td>
                            <span className={cdBase.repairContractsListObjectAddressLabel}>
                              {objName}
                            </span>
                            <span className={cdBase.repairContractsListObjectBadge}>
                          ...
                          <td>—</td>
                          <td>—</td>
                          <td className={cdHub.repairContractsListActionsCol} />
                        </tr>
                      );
                    }
                    ...
                    const rowClass = item.childOfObject
                      ? `${dataTableStyles.row} ${cdHub.repairContractsListClickableRow} ${cdBase.repairContractsListChildRow}`
                      : `${dataTableStyles.row} ${cdHub.repairContractsListClickableRow}`;
                    return (
                      <tr
                        key={r.id}
                        className={rowClass}
                      ...
                      >
                        <td className={cdHub.repairContractsListSelectCol} />
                        <td className={cdHub.repairContractsListKindCol}>
                        ...
                        <td
                          className={cdHub.repairContractsListActionsCol}
                          onClick={(e) => e.stopPropagation()}
                          onKeyDown={(e) => e.stopPropagation()}
                        >
                          <div
                            className={`${cdEstimatesList.estimatesCardActions} ${cdEstimatesList.repairContractsListActionsGrid}`}
                          >
                            <div className={cdEstimatesList.repairContractsListActionsSlot}>
                            ...
                            <div className={cdEstimatesList.repairContractsListActionsSlot}>
                              ...
                              >
                                <CopyIcon
                                  className={
                                    copyBusy ? cdChrome.estimatesRefreshIconSpinning : undefined
                                  }
                                />
                              </AdminTableIconButton>
                            </div>
                            <div className={cdEstimatesList.repairContractsListActionsSlot}>
                              ...
                              >
                                <DeleteIcon
                                  className={
                                    deleteBusy ? cdChrome.estimatesRefreshIconSpinning : undefined
                                  }
                                />
                              </AdminTableIconButton>
                            </div>
                            <div className={cdEstimatesList.repairContractsListActionsSlot}>
                              {actPhotoItems.length > 0 ? (
                                ...
                                <span
                                  className={
                                    cdEstimatesList.repairContractsListActionsIconPlaceholder
                                  }
                                  aria-hidden
                                />
                              )}
        ...
        {!loading && totalVisible > 0 ? (
          <AdminTablePagination
            ...
            className={cdHub.repairContractsListPagination}
            activePageClassName={cdHub.repairContractsListPaginationPageActive}
          />
        ) : null}
      </div>
      ...
      >
        {actPhotosModal ? (
          <div data-modal-form data-modal-density="compact">
            ...
            <div className={cdHubModals.repairAttachedActPhotosList}>
              {actPhotosModal.items.map((it) => (
                <section key={it.key} className={cdHubModals.repairAttachedActPhotoBlock}>
                  <h3 className={cdHubModals.repairAttachedActPhotoTitle}>{it.title}</h3>
                  <p className={cdHubModals.repairAttachedActPhotoMeta}>
                    Дата по акту: <strong>{it.dateLabel}</strong>
                  </p>
                  <div className={cdHubModals.repairWorkStartModalPreview}>
                    <a
                      href={it.src}
                      target="_blank"
                      rel="noopener noreferrer"
                      className={cdHubModals.repairAttachedActPhotoImageLink}
                    >
                      <img src={it.src} alt={it.title} />
                    </a>
                  </div>
                  <p className={cdHubModals.repairAttachedActPhotoLinkLine}>
