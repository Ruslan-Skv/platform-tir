...
import {
  type ContractDocumentPackageUserRef,
...
export interface PackageContractTrashModalProps {
  isOpen: boolean;
  onClose: () => void;
  onRestored?: () => void;
}

export function PackageContractTrashModal({
  isOpen,
  onClose,
  onRestored,
}: PackageContractTrashModalProps) {
      ...
      >
        <div className={styles.searchRow} data-modal-form-grid>
          <div data-modal-form-group data-modal-span>
            <label htmlFor="package-contract-trash-search">Поиск в корзине</label>
            <input
              id="package-contract-trash-search"
              type="search"
