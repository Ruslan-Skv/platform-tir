...
} from '../../../shared/contractDateFormat';
...
export type PackageDocumentLoadSetters = {
  ...
  setTemplateOverrides: React.Dispatch<
    React.SetStateAction<Partial<Record<RepairDocumentTemplateTabId, string>>>
  >;
  ...
  setRepairInstallers: React.Dispatch<React.SetStateAction<InstallerMaster[]>>;
  ...
  setRepairPackages: React.Dispatch<
