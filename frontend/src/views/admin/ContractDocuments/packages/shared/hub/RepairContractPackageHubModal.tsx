...
import type { BuildPersistedFormDataOptions } from '../../directions/repair/formDataTemplateStorage';
import { RepairContractPaymentsJournalModal } from '../../directions/repair/payments/RepairContractPaymentsJournalModal';
import { RepairContractPaymentsTab } from '../../directions/repair/payments/RepairContractPaymentsTab';
    ...
    <>
        ...
        <div data-modal-form data-modal-density="compact">
          ...
          <div
            ...
            className={
              isProductDirectionPackageKind(hub.packageKind)
                ? undefined
                : cdHubModals.repairWorkStartModalTopGrid
            }
          >
            <div data-modal-form-group>
              ...
              <div className={cdHubModals.repairWorkStartModalDateFieldWrap}>
                <input
            ...
            {hub.packageKind === 'REPAIR' ? (
              <div data-modal-form-group>
                ...
                <div className={cdHubModals.repairWorkStartModalFileRow}>
                  <input
                    ref={workStartFileInputRef}
                    id="hub_repair_work_start_act_photo"
                    type="file"
                    className={cdHubModals.repairWorkStartModalFileInputSrOnly}
                  ...
                  <label
                    ...
                    className={cdHubModals.repairWorkStartModalFilePickBtn}
                  >
      ...
      >
        <div data-modal-form data-modal-density="compact">
          ...
          <div data-modal-form-grid className={cdHubModals.repairWorkStartModalTopGrid}>
            <div data-modal-form-group>
        ...
        <div data-modal-form data-modal-density="compact">
          ...
          <div data-modal-form-group>
            ...
            <textarea
              ...
              className={cdChrome.repairContractRefusalReasonTextarea}
              rows={5}
