...
} from '../form/executorBankFields';
import type { PackageFormData } from '../form/packageForm';
import type { PackageInvoiceConductDraft } from './packageInvoiceConduct';
import { sumPaymentInvoiceLineItems } from './packagePaymentInvoiceLineItems';
...
export async function buildPackagePaymentInvoiceQrHtml(
  form: PackageFormData,
  conduct: PackageInvoiceConductDraft
): Promise<string> {
