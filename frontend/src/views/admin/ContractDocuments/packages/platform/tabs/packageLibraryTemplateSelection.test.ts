...
import {
  ...
  fixMisassignedProductLibraryPresetTabId,
  resolveLibraryTemplateSelection,
} from './packageLibraryTemplateSelection';
...
describe('fixMisassignedProductLibraryPresetTabId', () => {
  it('moves titled Памятка from contract to memo tab', () => {
    const fixed = fixMisassignedProductLibraryPresetTabId(
