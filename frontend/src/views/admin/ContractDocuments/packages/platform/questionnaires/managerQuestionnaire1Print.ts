...
function buildTrafficSourcePrintBlock(q: PackageManagerQuestionnaire1Block): string {
...
function buildWhyChosenPrintBlock(q: PackageManagerQuestionnaire1Block): string {
...
export function buildManagerQuestionnaire1PrintHtml(form: PackageFormData): string {
