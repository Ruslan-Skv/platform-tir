...
const DATA_TAB_DENSE = `${cdBase.packageDataTabDense} ${cdDataTab.packageDataTabDense} ${cdEstimateTab.packageDataTabDense}`;
const DATA_BLOCK = PACKAGE_BLOCK;
const DATA_FORM_GRID = PACKAGE_FORM_GRID;
const DATA_TOP_ROW = `${cdBase.dataTopRow} ${cdDataTab.dataTopRow}`;
const DATA_TOP_BLOCK = `${cdBase.dataTopBlock} ${cdDataTab.dataTopBlock}`;
const DATA_SECTION_CARD = `${cdBase.sectionCard} ${PACKAGE_SECTION_CARD}`;
const DATA_BLANK_SHEET = `${cdBase.packageDataBlankSheet} ${styles.packageDataBlankSheet}`;
const DATA_SECTION_TITLE = `${cdBase.sectionTitle} ${cdDataTab.sectionTitle}`;
const DATA_FIELD = `${cdBase.field} ${PACKAGE_FIELD}`;
const DATA_PARTY_FIELD = `${cdBase.field} ${cdDataTab.field}`;
const DATA_SECTION_FIELDS = PACKAGE_SECTION_FIELDS;
const DATA_HINT = PACKAGE_HINT;
...
const CUSTOMER_SEARCH_SLOT = `${cdBase.packageCustomerSearchSlot} ${cdDataTab.packageCustomerSearchSlot}`;
  ...
  return (
    <div className={`${DATA_BLOCK} ${cdDataTab.dataCompact} ${DATA_TAB_DENSE}`}>
      <div className={DATA_FORM_GRID}>
        ...
        <div
          className={`${DATA_SECTION_CARD} ${DATA_BLANK_SHEET} ${styles.packageDataPartySection}`}
        >
