...
import type { useContractTemplateEditor } from '../hooks/useContractTemplateEditor';
...
import { PackageAddendumEditorPane } from './PackageAddendumEditorPane';
import { PackageDataTab, type PackageDataTabProps } from './PackageDataTab';
import { PackageEstimateTab, type PackageEstimateTabProps } from './PackageEstimateTab';
import {
  PackageFinalEstimateTab,
  type PackageFinalEstimateTabProps,
} from './PackageFinalEstimateTab';
import { PackageTemplateEditorPane } from './PackageTemplateEditorPane';
import {
