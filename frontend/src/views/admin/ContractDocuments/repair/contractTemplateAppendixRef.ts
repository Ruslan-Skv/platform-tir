...
export function repairContractAppendixRefInHtml(html: string): string {
...
export function repairContractAppendixRefInDom(docPrint: HTMLElement): void {
...
export function repairContractAppendixAndActTitlesInDom(root: ParentNode): void {
