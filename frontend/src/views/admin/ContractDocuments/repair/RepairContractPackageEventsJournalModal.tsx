...
import styles from './RepairContractPackageEventsJournalModal.module.css';
...
export type RepairContractPackageEventsJournalModalProps = {
  isOpen: boolean;
  onClose: () => void;
...
export function RepairContractPackageEventsJournalModal({
  isOpen,
  onClose,
  versions,
  versionsBusy,
  ...
  contractNumberLabel,
  contractDateLabel,
}: RepairContractPackageEventsJournalModalProps) {
