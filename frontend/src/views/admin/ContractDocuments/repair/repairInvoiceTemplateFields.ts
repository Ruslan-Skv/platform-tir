...
import type { RepairCustomerBlock, RepairExecutorBlock } from './repairPackageForm';
...
export { formatInvoiceBankAccount, parseExecutorBankDetails } from './repairExecutorBankFields';
export type { ParsedExecutorBankDetails } from './repairExecutorBankFields';
...
export function buildCustomerBuyerLine(customer: RepairCustomerBlock): string {
...
export type RepairInvoiceTemplateExtras = {
  supplierLine: string;
  buyerLine: string;
  bankName: string;
  bankBik: string;
...
export function buildRepairInvoiceTemplateExtras(
  executor: RepairExecutorBlock & { innKppRegLine: string },
