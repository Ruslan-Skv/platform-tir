...
} from './repair/repairWindowsWorkOrder';
  ...
  return (
    <div className={styles.page}>
      ...
      <section className={styles.repairSettingsCard}>
        <h2 className={styles.sectionTitle}>Окна — заказ-наряд</h2>
        {loading ? (
          ...
          <>
            ...
            {isSuperAdmin ? (
              ...
              <p className={styles.hint}>Изменить наценку может только суперадмин.</p>
            )}
          </>
        )}
      </section>
