...
const CARD_ITEMS = [
  ...
  'Исполнитель и автор получают уведомления в колокольчик: назначение, перенос между колонками, комментарии, смена срока и повышение приоритета до высокого/срочного.',
] as const;
