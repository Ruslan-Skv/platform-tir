...
export default async function AllProductsPageRoute({ searchParams }: AllProductsPageProps) {
...
export async function generateAllProductsMetadata({ searchParams }: AllProductsPageProps) {
  const sp = await searchParams;
  const parsed = parseNextSearchParamsRecord(sp);
