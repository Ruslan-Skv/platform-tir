...
export const dropdownMenus: DropdownMenus = {
  ...
  'НАШИ РАБОТЫ': {
    ...
    items: [
      {
        name: 'Ремонт санузла',
        href: '/portfolio/bathroom-renovation',
        productType: 'bathroom_renovation',
        icon: 'Home',
      },
      {
        name: 'Ремонт квартиры',
        href: '/portfolio/apartment-renovation',
      ...
      {
        name: 'Шкафы-купе',
        href: '/portfolio/sliding-wardrobes',
        productType: 'sliding_wardrobes',
        icon: 'CubeTransparent',
      },
      {
        name: 'Двери',
        href: '/portfolio/doors',
        productType: 'portfolio_doors',
        icon: 'RectangleStack',
      },
      {
        name: 'Окна',
        href: '/portfolio/windows',
        productType: 'portfolio_windows',
        icon: 'Squares2X2',
      },
      {
        name: 'Потолки натяжные',
        href: '/portfolio/stretch-ceilings',
        productType: 'portfolio_stretch_ceilings',
        icon: 'Cube',
      },
      {
        name: 'Жалюзи',
        href: '/portfolio/blinds',
        productType: 'portfolio_blinds',
        icon: 'ViewColumns',
      },
    ],
  },
