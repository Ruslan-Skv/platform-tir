  ...
  (this.workbox.routing = (function (t, e) {
    ...
    class i {
      ...
      handleRequest({ request: t, event: e }) {
        ...
        let o = i && i.handler;
        const u = t.method;
        if ((!o && this.dt.has(u) && (o = this.dt.get(u)), !o)) return;
        let c;
        try {
        ...
        return (
          c instanceof Promise &&
            ...
            (c = c.catch(async (r) => {
              if (a)
                try {
                  return await a.handle({ url: s, request: t, event: e, params: n });
                } catch (t) {
                  t instanceof Error && (r = t);
                }
              if (this.wt) return this.wt.handle({ url: s, request: t, event: e });
              throw r;
            })),
          c
        );
      ...
      unregisterRoute(t) {
        if (!this.ft.has(t.method))
          throw new e.WorkboxError('unregister-route-but-not-found-with-method', {
            method: t.method,
          });
    ...
    return (
      (t.NavigationRoute = class extends r {
        ...
        gt({ url: t, request: e }) {
          ...
          for (const t of this.yt) if (t.test(s)) return !1;
